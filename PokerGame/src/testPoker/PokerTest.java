...
public class PokerTest {
	...
	// "C6", "D6", "H6" => isThreeOfaKind=true
	// ("C6", "D6"), ("H6", "S6") => isTwoPairs=true
	// according to rules it should be true, but actually it is not full house
	// incorrectly classify to full house
